                ...
                <div class=" row">
                    <div class="mt-3 col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="usersName" readonly value="{{ $user->nom_ag }}"
                                disabled>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="usersName" readonly value="{{ $user->mat_ag }}"
                                disabled>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 col-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="usersEmail" readonly value="{{ $user->email }}"
                                disabled>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="StatutUser" readonly value="{{ $user->sta_ag }}"
                                disabled>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 col-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="usersEmail" value="{{ $user->created_at }}"
                                disabled>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 col-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="usersEmail" value="{{ $user->updated_at }}"
                                disabled>
                        </div>
                    </div>
