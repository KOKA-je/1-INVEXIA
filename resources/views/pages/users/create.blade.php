            ...
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="mt-3 col-6">
                        ...
                        <input type="text" name="mat_ag" class="form-control" id="mat_ag" value="{{ old('mat_ag') }}"
                            required>
                    </div>

                    <div class="mt-3 col-6">
                        <label for="name" class="form-label">Nom de l'utilisateur</label>
                        <input type="text" name="nom_ag" class="form-control" id="nom_ag" value="{{ old('nom_ag') }}"
                            required>
                    </div>

                    <div class="mt-3 col-6">
                        <label for="name" class="form-label">Prenom de l'utilisateur</label>
                        <input type="text" name="nom_ag" class="form-control" id="nom_ag"
                            value="{{ old('pren_ag') }}" required>
                    </div>

                    <div class="mt-3 col-6">
                        <label for="usersEmail" class="form-label">Email de l'utilisateur</label>
                        <input type="email" name="email" class="form-control" id="usersEmail"
                    ...
                    <div class="mt-3 col-6">
                        <div class="form-group">
                            ...
                            <select name="sta_ag" id="sta_ag" class="js-example-basic-single form-select">
                    ...
                    <div class="mt-3 col-6">
                        <label for="name" class="form-label">Direction de l'utilisateur</label>
                        <input type="text" name="dir_ag" class="form-control" id="dir_ag" value="{{ old('dir_ag') }}"
                            required>
                    </div>

                    <div class="mt-3 col-6">
                        <label for="name" class="form-label">Localisation de l'utilisateur</label>
                        <input type="text" name="loc_ag" class="form-control" id="loc_ag" value="{{ old('loc_ag') }}"
                            required>
                    </div>
